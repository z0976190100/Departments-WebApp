...
public class MessageManager {
    ...
    private Map<String, String> respMes = new HashMap<>();

    public  Map<String, String> getRespMes() {
        return respMes;
    }

    public void setRespMes(Map<String, String> respMes) {
    ...
    public static final String INVALID_DATE_MESSAGE = "INVALID_DATE_MESSAGE";
